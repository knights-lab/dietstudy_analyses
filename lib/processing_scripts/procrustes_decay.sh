...
# Usage: procrustes_decay.sh

# first activate qiime conda environment 
source activate qiime

#navigate to correct dir
cd /Users/abby/Documents/Projects/dietstudy_analyses/data/procrustes/data_username_decay
...
for i in *_food.biom;
do beta_diversity.py -i $i -o ${i//_food.biom}_food_beta -t ../../diet/diet.tree.txt;
done
...
#for i in *_food_beta;
#do transform_coordinate_matrices.py -i $i/${i//_beta}_pcoa.txt,${i//_food_beta}_tax_beta/${i//_food_beta}_tax_pcoa.txt -o ../results_username/${i//_food_beta}_procrustes_results/ -r 999;
#done
...
#do make_emperor.py -c -i $i/ -o $i/plots/ -m ../data_username/${i//_procrustes_results}_map.txt --add_unique_columns --custom_axes StudyDayNo;
#done
